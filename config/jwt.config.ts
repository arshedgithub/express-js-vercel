...
const jwtConfigSchema = {
  ...
  required: ['JWT_SECRET', 'JWT_EXPIRATION', 'JWT_USERNAME', 'JWT_ID', 'JWT_ACCESS_TOKEN_EXPIRATION', 'JWT_REFRESH_TOKEN_EXPIRATION', 'JWT_REFRESH_SECRET'],
};
...
const defaultJwtConfig = {
  ...
  JWT_REFRESH_SECRET: 'IMONE_REFRESH',
};
...
export const JWTConfig = {
  ...
  JWT_REFRESH_SECRET: process.env.JWT_REFRESH_SECRET || defaultJwtConfig.JWT_REFRESH_SECRET,
};
